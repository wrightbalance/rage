<form class="form form-horizontal" method="post" action="<?=site_url('account/post')?>">
	...
	<div class="frow graybtn">
		<a href="<?=site_url('account/login')?>" class="btn btn-success">Already have an account? Just Login</a>
	</div>
